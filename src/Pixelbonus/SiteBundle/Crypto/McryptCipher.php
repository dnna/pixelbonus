<?php
namespace Pixelbonus\SiteBundle\Crypto;
...
class McryptCipher
{
    ...
    private function derivateSecureKeys($pbkdf2Salt = null)
    {
        if ($pbkdf2Salt) {
            ...
            $this->pbkdf2Salt = base64_decode('Pnx9Pqq8mrt4DHDUDuS/rcsIVPjaNYxzwBmzhyeSap4=');
        }
    ...
    public function encrypt($input)
    {
        ...
        $encrypted = mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->secureEncryptionKey, $input, MCRYPT_MODE_CBC, base64_decode('BtchsNq1CMkCdKuAlv6yCA=='));
    ...
    public function decrypt($input)
    {
        ...
        return rtrim(
            mcrypt_decrypt(MCRYPT_RIJNDAEL_128, $this->secureEncryptionKey, $encrypted, MCRYPT_MODE_CBC, base64_decode('BtchsNq1CMkCdKuAlv6yCA==')),
            "\0"
        );
    }
